...
class StandupListViewTests(BaseAPITestCase):
    url = "/api/v1/standups/"
    ...
    def test_authenticated_users_can_retrieve_the_standup_list(self):
    ...
    def test_standups_from_different_users_are_returned(self):
        self._create(self.user, datetime.date(2026, 7, 13))
    ...
    def test_results_are_ordered_correctly(self):
        ...
        newer = self._create(self.other, datetime.date(2026, 7, 15))
    ...
    def test_empty_database_returns_empty_paginated_result(self):
        response = self.client.get(self.url)
